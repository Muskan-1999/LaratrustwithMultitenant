<x-app-layout>
    ...
    <div class="card bg-base-100 shadow p-5">
        ...
        <p class="text-sm text-gray-600 mb-4">If a dog chews shoes whose shoes does he choose?</p>
    ...
    <span class="mr-2 inline-flex items-center justify-center w-6 h-6 rounded-full bg-black text-white text-sm font-bold">
        ?
    </span>
    Quick Start Guide
</h3>
